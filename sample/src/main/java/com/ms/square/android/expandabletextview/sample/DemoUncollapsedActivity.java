 ...
 * @author Manabu-GT
 */
public class DemoUncollapsedActivity extends AppCompatActivity {
    ...
    public static class Demo1Fragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            expTv1.setCollapsed(false);
            expTv2.setText(getString(R.string.dummy_text2));
            expTv2.setCollapsed(true);
            return rootView;
        }
    }
    ...
    public static class Demo2Fragment extends ListFragment {
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            SampleUncollapsedTextListAdapter adapter = new SampleUncollapsedTextListAdapter(getActivity());
